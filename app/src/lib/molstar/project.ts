...
// This is the promoted, reusable version of the wiring that lived inline in the spike
// panel (hardcoded to conformer-count there).
 ...
 * (The spike cached its volume forever and could never switch metrics — this is the fix.) */
